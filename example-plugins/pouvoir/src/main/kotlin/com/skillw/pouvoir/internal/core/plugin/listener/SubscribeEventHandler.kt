package com.skillw.pouvoir.internal.core.plugin.listener
...
object SubscribeEventHandler: ClassHandler(1) {
    override fun handle(clazz: ClassStructure) {
        if (clazz.isInterface || clazz.isAbstract || !clazz.isAnnotationPresent(SubscribeEvent::class.java)) return
